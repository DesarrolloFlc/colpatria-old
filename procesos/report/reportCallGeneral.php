<?php
session_start();
if (!isset($_SESSION['group']) || !in_array($_SESSION['group'], ["1", "6", "8"])) {
...
?>
<!-- Page Head -->
<h2>Reporte interno de gesti&oacute;n telef&oacute;nica</h2>
<p id="page-intro">Detalle de los contactos telef&oacute;nicos realizados a los clientes.</p>
...
<div class="content-box"  id="box_search_result">    
    ...
    <div class="content-box-content">        
		...
		<form action="reportCallGeneral.xls.php" method="POST" name="reportGeneral" id="reportGeneral"/>
            <table>
                <tbody>
                   <tr>
			<td>Fecha inicio:</td>
