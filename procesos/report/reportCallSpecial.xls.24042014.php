...
if($_SESSION['id'] == 1 || $_SESSION['id'] == 23 || $_SESSION['id'] == 2090 || $_SESSION['id'] == 2995){
	...
	fputcsv($fh, array('Tipo de persona','Sucursal','Area','Funcionario','Planilla','Lote Colpatria','Marca','Tipo de Cliente',
		...
		'Hora de Entrevista','Resultado Entrevista','Intermediario Entrevista','Usuario'), ';');
	while($registro = mysqli_fetch_array($result)) {

		if(is_null($registro[72]) || empty($registro[72]) || $registro[72] == '0000-00-00') $registro72 = "2013-06-12"; else $registro72 = $registro[72];
		if(is_null($registro[73]) || empty($registro[73]) || $registro[73] == '0000-00-00') $registro73 = "2013-06-12"; else $registro73 = $registro[73];
		if($registro[16] == "") $registro16 = "SD"; else $registro16 = $registro[16];
		if($registro[20] == "") $registro20 = "NA"; else $registro20 = $registro[20];
		if($registro[71] == "") $registro71 = "NA"; else $registro71 = $registro[71];
		if($registro[74] == "") $registro74 = "NA"; else $registro74 = $registro[74];
		if($registro[36] == "") $registro36 = "NA"; else $registro36 = $registro[36];
		if($registro[38] == "") $registro38 = "NA"; else $registro38 = $registro[38];
		if($registro[0] == 'NATURAL') $registro68 = "NA";else $registro68 = $registro[68];
		if($registro[0] == 'NATURAL') $registro69 = "NA";else $registro69 = $registro[69];
		if($registro[0] == 'NATURAL') $registro70 = "NA";else $registro70 = $registro[70];

		fputcsv($fh, array($registro[0],$registro[1],$registro[2],$registro[3],$registro[4],$registro[5],$registro[6],
			...
			$registro[56],$registro[57],$registro[58],$registro68,$registro69,$registro70,$registro[59],$registro[60],
			$registro[61],$registro[62],$registro[63],$registro[64],$registro[65],$registro[66],$registro[67]), ';');
...
?>
<tr>
<td style="border:dotted; border-width:1px;"><?php echo $registro[0] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[1] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[2] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[3] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[4] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[5] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[6] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[7] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[8] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[9] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[10] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[11] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[12] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[13] ?></td>
<td style="border:dotted; border-width:1px;"><?php if($registro[72] == '0000-00-00')echo '2013-06-12'; else echo $registro[72]; ?></td>
<td style="border:dotted; border-width:1px;"><?php if($registro[73] == '0000-00-00')echo '2013-06-12'; else echo $registro[73]; ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[14] ?></td>
<!--<td style="border:dotted; border-width:1px;"><?php //echo $registro[15] ?></td>-->
<td style="border:dotted; border-width:1px;"><?php if( $registro[16] == "") echo "SD"; else echo $registro[16];  ?></td>
<!--<td style="border:dotted; border-width:1px;"><?php echo $registro[17] ?></td>
<td style="border:dotted; border-width:1px;"><?php //echo $registro[18] ?></td>-->
<td style="border:dotted; border-width:1px;"><?php echo $registro[19] ?></td>
<td style="border:dotted; border-width:1px;">
<?php if($registro[20] == "")echo "NA"; else echo $registro[20]; ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[21] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[22] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[23] ?></td>
<td style="border:dotted; border-width:1px;"><?php if($registro[71] == "")echo "NA"; else echo $registro[71]; ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[24] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[25] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[26] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[27] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[28] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[29] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[30] ?></td>
<td style="border:dotted; border-width:1px;"><?php if($registro[74] == "")echo "NA"; else echo $registro[74]; ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[31] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[32] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[33] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[34] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[35] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[36] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[37] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[38] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[39] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[40] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[41] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[75] ?></td>
<!--<td style="border:dotted; border-width:1px;"><?php //echo $registro[42] ?></td>-->
<td style="border:dotted; border-width:1px;"><?php echo $registro[42] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[44] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[45] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[46] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[47] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[48] ?></td>
<!--<td style="border:dotted; border-width:1px;"><?php //echo $registro[49] ?></td>-->
<td style="border:dotted; border-width:1px;"><?php echo $registro[49] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[51] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[52] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[53] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[54] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[55] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[56] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[57] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[58] ?></td>
<td style="border:dotted; border-width:1px;">
<?php if($registro[0] == 'NATURAL')echo "NA";else echo $registro[68];
?>
</td>
<td style="border:dotted; border-width:1px;">
<?php if($registro[0] == 'NATURAL')echo "NA";else echo $registro[69];
?>
</td>
<td style="border:dotted; border-width:1px;">
<?php if($registro[0] == 'NATURAL')echo "NA";else echo $registro[70];
?>
</td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[59] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[60] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[61] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[62] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[63] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[64] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[65] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[66] ?></td>
<td style="border:dotted; border-width:1px;"><?php echo $registro[67] ?></td>
</tr>
<?php
}
?>
