...
if( isset($_SESSION['group']) && $_SESSION['group'] == "6" OR  $_SESSION['group'] == "1" OR  $_SESSION['group'] == "8" OR  $_SESSION['group'] == "2") {
...
<p id="page-intro">Radicar documentos virutuales a enviar por sucursal.</p>
              ...
              <table>
                <tr>
                  <td colspan="2">
                    ...
                    <div style="display: inline; width: 16px; heigth: 16px;">
