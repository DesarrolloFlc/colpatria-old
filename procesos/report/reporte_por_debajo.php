...
require_once PATH_CCLASS . DS . 'client.class3.php';
$complemento = '';
...
SELECT IF(cl.persontype = '1', 'NATURAL','JURIDICO'),
	   ...
	   IF(da.formulario = '15', CONCAT(cr.ciudad, ', ', cr.departamento), IF(cl.persontype = '1', lugar_resi.description, lugar_resi.description)) AS ciudadresidencia, 
	   da.nombreempresa, 
	   da.direccionempresa,
	   da.nomenclatura,
	   da.telefonolaboral, 
...
$cabeza = array(
	...
	'GENERO', 'TIPO DE DOCUMENTO', 'NUMERO IDENTIFICACION', 'FECHA EXPEDICION', 'LUGAR EXPEDICION',
...
$fh = fopen("reportCallSpecial_".date('His').".csv", "a");
fputcsv($fh, $cabeza, ';');
$conn2 = new Conexion();
