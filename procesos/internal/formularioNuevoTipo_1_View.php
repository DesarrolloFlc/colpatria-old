...
<tr>
	...
	<td>
		<input type="text" id="direccionoficinappal" name="direccionoficinappal" style="width: 180px; margin-right: 15px" onkeypress="return validar_letra(event)" title="Direccion" onblur="$(this).ocultarEsteCampo(event);">
		Telefono:
		<input type="text" id="telefonoficinappal" name="telefonoficinappal" style="width: 100px" onchange="$(this).checkTamanoTele(event, 7);" maxlength="7" title="Telefono"><!--agregar campo llamado telefonoficinappal-->
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" id="direccionoficinappal2" name="direccionoficinappal2" style="width: 180px; margin-right: 15px" onkeypress="return validar_letra(event)" title="Direccion" onblur="$(this).validarCampoReescrito(event, 'input', 'form_fingering', 'direccionoficinappal', 'Las direcciones no coinciden por favor validelas.');">
	</td>
</tr>
<tr>
