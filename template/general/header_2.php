...
<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
        ...
        <div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
                ...
                <!-- Logo (221px wide) -->
                <center><a href="#"><img id="logo" src="<?=SITE_ROOT?>/images/general/logo_colpatria.jpg" alt="Colpatria." width="180px" height="122px"></a></center>

                <!-- Sidebar Profile links -->
                <div id="profile-links">
                    Hola, <a href="#" title="Edit your profile">
<?php
...
?>
                    ...
                    tienes <a href="#messages" rel="modal" title="3 Messages">0 Mensajes</a><br />
                    <br />
...
?>
                            ...
                            <li><a href="#" onClick="pantallaCompleta('<?=SITE_ROOT?>/procesos/internal/fingering2.php');
                                        return false;" target="_blank">Digitar imágenes</a></li> <!-- Add class "current" to sub menu items also -->
<?php
    }
    if (isset($_SESSION['group']) && $_SESSION['group'] == "6" || $_SESSION['group'] == "3"): 
?>
                            <li><a href="#" onClick="pantallaCompleta('<?=SITE_ROOT?>/procesos/internal/fingering_migracion.php');
                                            return false;" target="_blank">Digitar im&aacute;genes migracion</a></li>   
<?php
    endif;
...
?>
                    <li> 
                        ...
                        <ul>
                            ...
                            <?php if (isset($_SESSION['group']) && $_SESSION['group'] == "6"): ?>	
...
?>
                    <li> 
                        ...
                        <ul>  
                            <?php if (isset($_SESSION['group']) && $_SESSION['group'] == "5" OR $_SESSION['group'] == "6") { ?>
