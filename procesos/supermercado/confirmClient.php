...
$data_client = Supermercado::getDataSeguros($id_client);
...
<!-- Page Head -->
<h2>Confirmación de cliente en Seguros Supermercado</h2>
...
<table>
	...
	<tbody>
		<tr>
			...
			<td><?php echo $data_client['fechacompra']?></td>
			<td><b>Fecha de Emici&oacute;n:</b></td>
			<td><?php echo $data_client['fechaemision']?></td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>Nombres:</b></td>
			<td><?php echo $data_client['primernombre']." ".$data_client['segundonombre']." ".$data_client['primerapellidos']." ".$data_client['segundoapellido']?></td>
		...
		<tr>
			<td><b>Empresa:</b></td>
			<td><?php echo $data_client['empresatrabajo']?></td>
			<td></td>
			<td></td>
		</tr>
		<tr>
			<td><b>Direcci&oacute;n laboral:</b></td>
			<td><?php echo $data_client['direcciontrabajo']?></td>
			<td><b>Telefono laboral:</b></td>
			<td><?php echo $data_client['telefonotrabajo']?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?php echo $data_client['teltfonoresidencia']?></td>
			<td></td>
			<td></td>
		</tr>
        <tr>
            <td><b>Numero de producto:</b></td>
            <td><?php echo $data_client['numeroproducto']?></td>
            <td><b>Producto comprado:</b></td>
            <td><?php echo $data_client['productocomprado']?></td>
        </tr>
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
		...
		<form  action="saveContact.php" id="confirmClientCapi" name="confirmClientCapi"  method="POST" enctype="multipart/form-data" target="grp2">
...
<?php if($persontype == "1"): ?>
                ...
                <p>
                    ...
                    <input class="text-input small-input" type="text" id="primerapellidos" name="primerapellidos" value="<?php echo $data_client['primerapellidos'];?>" />
                </p>
                <p>
                ...
                <p>
                    ...
                    <input class="text-input small-input" type="text" id="primernombre" name="primernombre" value="<?php echo $data_client['primernombre'];?>" />
                </p>
                <p>
                    <label>Segundo nombre:</label>
                    <input class="text-input small-input" type="text" id="segundonombre" name="segundonombre" value="<?php echo $data_client['segundonombre'];?>" />
                </p>
                <p>
                <?php
            ...
            <p>
        		...
        		<p>
                        ...
                        <input class="text-input small-input" type="text" id="telefonoresidencia" name="telefonoresidencia" value="<?php echo $data_client['teltfonoresidencia'];?>" /> 
                    </p>

        		<p>
                        <label>Empresa donde labora:</label>
                        <input class="text-input small-input" type="text" id="empresatrabajo" name="empresatrabajo" value="<?php echo $data_client['empresatrabajo'];?>" /> 
                    </p>
        		<p>
                        <label>Direcci&oacute;n laboral:</label>
                        <input class="text-input small-input" type="text" id="direcciontrabajo" name="direcciontrabajo" value="<?php echo $data_client['direcciontrabajo'];?>" /> 
                    </p>
            <p>
                    ...
                    <input type="hidden" name="totalactivos" id="totalactivos" value="<?php echo $data_client['totalactivos'];?>">
                    <input type="hidden" name="totalpasivos" id="totalpasivos" value="<?php echo $data_client['totalpasivos'];?>">
			<!--<p>
                        <label>Activos:</label>
...
<?php 
	...
	?>
        ...
        <iframe  width="1" height="1" id="grp2" name="grp1" style="visibility:hidden"></iframe>
		</form>
                <div class="clear"></div><!-- End .clear -->
