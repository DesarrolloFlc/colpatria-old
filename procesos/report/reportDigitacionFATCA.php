...
?>
    <!-- Page Head -->
<h2>Reporte interno de indexaci&oacute;n FATCA</h2>
...
<div class="content-box"  id="box_search_result">    
    ...
    <div class="content-box-content">        
        <div class="tab-content default-tab" id="tab2">
            <form action="reportDigitacionFATCA.xls.php" method="POST" name="reportDigitacionFATCA" id="reportDigitacionFATCA" target="grp_linde">
                <table>
                    <tbody>
                        <tr>
                            <td>Fecha inicio:</td>
